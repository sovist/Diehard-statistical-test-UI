...
{
 unsigned int j0=0,k0=0,j,k,t, i;
 Xtest ptest;
 char** w;
 ...
 w = (char **)calloc(1024, sizeof(char*));

 for (j = 0; j < 1024; j++)
 {
    w[j] = (char *)calloc(1024, sizeof(char));
	memset(w[j], 0, sizeof(char)*1024);
 }
 ...
 //memset(ww,0,sizeof(char)*1024*1024);
