...
#include "../code_files/include/rgb_lmn.h"
#include "../code_files/include/marsaglia_tsang_gorilla.h"




int rgb_lmn(/*Dtest*/ Test **dtest_,/*Test **test*/ int irun)
{

 double pks;
 unsigned int ps_save=0,ts_save=0;
