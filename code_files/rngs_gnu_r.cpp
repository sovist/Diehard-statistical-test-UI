...
RNGTAB RNG_Table[] =
{
    ...
    { WICHMANN_HILL,        BUGGY_KINDERMAN_RAMAGE, "Wichmann-Hill", 	       3,	dummyvec},
    { MARSAGLIA_MULTICARRY, BUGGY_KINDERMAN_RAMAGE, "Marsaglia-MultiCarry",	   2,	dummyvec},
    { SUPER_DUPER,          BUGGY_KINDERMAN_RAMAGE, "Super-Duper",		       2,	dummyvec},
    { MERSENNE_TWISTER,     BUGGY_KINDERMAN_RAMAGE, "Mersenne-Twister",	    1+624,	dummyvec},
    { KNUTH_TAOCP,          BUGGY_KINDERMAN_RAMAGE, "Knuth-TAOCP",          1+100,	dummyvec},
    { USER_UNIF,            BUGGY_KINDERMAN_RAMAGE, "User-supplied",            0,	dummyvec},
    { KNUTH_TAOCP2,         BUGGY_KINDERMAN_RAMAGE, "Knuth-TAOCP-2002",     1+100,	dummyvec},
};
