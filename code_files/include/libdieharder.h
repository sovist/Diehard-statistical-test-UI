...
#define GVECMAX 100
 ...
 extern          int iterations;	    /* For timing loop, set iterations to be timed */
...
#define MAXFIELDNUMBER 8
  ...
  * legend.
  */
 extern long long filecount;	/* number of rands in file */
 ...
 extern double progressGeneralInc;
 extern double progressGeneral;
 extern double progressTest;
 extern int fileRewound;
 extern FILE* inputFile;
 extern unsigned int first_file_input_raw_set;

#include "..//Diehard/TableForm.h"
public ref class Globals
{
  public: static Diehard::TableForm^ _tableForm;
};
